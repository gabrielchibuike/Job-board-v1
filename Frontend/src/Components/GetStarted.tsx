  ...
  return (
    <>
      <div className="w-full min-h-screen flex flex-col justify-center">
        <div className="w-full min-h-[400px] flex bg-zinc-100 p-8 sm:p-10 rounded-2xl max-lg:flex-col-reverse">
          <div className="w-[50%] space-y-5 max-lg:w-full max-lg:space-y-2 flex flex-col justify-center">
            <div className="font-semibold text-3xl max-lg:text-2xl max-lg:mt-5 max-lg:text-center">
              Advance <span className="text-blue-700 italic"> your career </span>with
              Konnect.
            </div>
          ...
          <div className="w-[50%] bg-slate-500 flex justify-center max-lg:w-full rounded-2xl">
            <img
              src="./man2.png"
              alt=""
              className="object-contain w-[300px] max-lg:w-[200px] "
            />
          </div>
        </div>
      </div>
